                ...
                <div className="fixed inset-0 z-[100] bg-white animate-fade-in flex flex-col">
                    ...
                    <div className="flex-1 overflow-y-auto p-4 bg-slate-50">
                        <div className="max-w-2xl mx-auto bg-white rounded-xl shadow-lg overflow-hidden border border-gray-100">
                            <div className="flex justify-between bg-gray-50 p-3 border-b border-gray-200">
                            ...
                            {stopsToRender.map((stop, i) => {
                                ...
                                return (
                                    <div key={i} className="flex justify-between items-center p-4 border-b border-gray-50 last:border-0 hover:bg-teal-50/50 transition-colors group">
                                        <div className="flex items-center gap-3 flex-1 min-w-0 pr-4">
                                            ...
                                            <div className="flex flex-col min-w-0">
                                                <span className="text-sm font-bold text-gray-800 break-words leading-tight">{stop.name}</span>
                                        ...
                                        <div className="text-right shrink-0">
                                            <span className="text-xs font-mono font-bold text-teal-700 bg-teal-50 px-2 py-1 rounded border border-teal-100 whitespace-nowrap">{stop.time}</span>
                                        </div>
                                    </div>
                                )
                            })}
                                    ...
                                    {displayStops.map((stop, i) => {
                                        ...
                                        return (
                                            <div key={i} className="ml-6 relative group">
                                                ...
                                                >
                                                    {/* --- LEFT SIDE: NAME (Wraps now) --- */}
                                                    {/* min-w-0 and flex-1 are crucial here to allow text wrapping inside a flex container */}
                                                    <div className="flex flex-col flex-1 min-w-0">
                                                        <span className="text-lg font-bold text-gray-900 break-words leading-tight hover:text-teal-700 transition-colors">
                                                            {stop.name}
                                                        </span>
                                                        {isStart && <span className="text-xs font-black text-teal-600 uppercase tracking-wide mt-1">ORIGIN</span>}
                                                        {isEnd && <span className="text-xs font-black text-indigo-600 uppercase tracking-wide mt-1">DESTINATION</span>}
                                                    </div>

                                                    {/* --- RIGHT SIDE: TIME (Fixed width, won't shrink) --- */}
                                                    {/* shrink-0 ensures the time box never gets squished by a long name */}
                                                    <div className="shrink-0 pt-0.5">
                                                        <span className="text-sm font-mono font-bold text-teal-800 bg-teal-50 px-3 py-1 rounded border border-teal-100 whitespace-nowrap block text-center">
                                                            {stop.time}
                                                        </span>
                                                    </div>
                                                </div>
                                            ...
                                            <div key={i} className="ml-6 relative group">
                                                ...
                                                >
                                                    <div className="flex flex-col flex-1 min-w-0 pr-3">
                                                        ...
                                                        <span className="text-lg font-bold text-gray-900 break-words leading-tight hover:text-teal-700 transition-colors">{stop.name}</span>
                                                    ...
                                                    <span className="text-sm font-mono font-bold text-teal-800 bg-teal-50 px-3 py-1 rounded border border-teal-100 whitespace-nowrap shrink-0">{stop.time}</span>
                                                </div>
                                            </div>
                                        )
                                    })}
